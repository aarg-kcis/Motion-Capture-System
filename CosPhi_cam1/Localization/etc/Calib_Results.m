...
%-- Focal length:
fc = [ 489.22706989 ; 488.85129361 ];

%-- Principal point:
cc = [ 289.0637025 ;  217.61235891 ];

%-- Skew coefficient:
alpha_c = 0.000000000000000;

%-- Distortion coefficients:
kc = [ -0.11818684 ; 0.05460047 ; -0.00113477 ; 0.00390341 ; 0.000000000000000 ];

%-- Focal length uncertainty:
fc_error = [ 4.19397917 ; 4.11998862 ];

%-- Principal point uncertainty:
cc_error = [ 2.45221984 ; 2.11031636 ];

%-- Skew coefficient uncertainty:
alpha_c_error = 0.000000000000000;

%-- Distortion coefficients uncertainty:
kc_error = [ 0.00384676 ; 0.00419129 ; 0.00066162 ; 0.00084911 ; 0.000000000000000 ];
