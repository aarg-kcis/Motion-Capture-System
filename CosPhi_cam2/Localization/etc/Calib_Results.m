...
%-- Focal length:
fc = [ 532.91057712 ; 532.46863151 ];

%-- Principal point:
cc = [ 333.2128457 ; 239.098808 ];

%-- Skew coefficient:
alpha_c = 0.000000000000000;

%-- Distortion coefficients:
kc = [ -0.11772806 ; 0.12641521 ; -0.00343579 ; 0.01132213 ; 0.000000000000000 ];

%-- Focal length uncertainty:
fc_error = [ 1.78594799 ; 1.81449462 ];

%-- Principal point uncertainty:
cc_error = [ 2.14100162 ; 1.72981409 ];

%-- Skew coefficient uncertainty:
alpha_c_error = 0.000000000000000;

%-- Distortion coefficients uncertainty:
kc_error = [ 0.00548165 ; 0.01098442 ; 0.00091223 ; 0.00092174 ; 0.000000000000000 ];
